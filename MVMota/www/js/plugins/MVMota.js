...
////    //HUD界面   启发自 夏末渐离
    ...
    MVMota.Window_HUD.prototype.drawALLText= function(){
        ...
        var Py=50;
        var i=1;
        this.drawDataText(MVMota.mainHero.floor,"楼层",Px, Py/10);
        this.drawDataText(MVMota.mainHero.hp,"血量",Px,Py*(i++));
        this.drawDataText(MVMota.mainHero.atc,"攻击",Px,Py*(i++));
        this.drawDataText(MVMota.mainHero.def,"防御",Px,Py*(i++));
        this.drawDataText(MVMota.mainHero.money,"金币",Px,Py*(i++));
